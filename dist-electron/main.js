...
async function l() {
	...
	}), c.removeMenu(), process.env.VITE_DEV_SERVER_URL ? (c.loadURL(process.env.VITE_DEV_SERVER_URL), c.webContents.openDevTools()) : (c.loadFile(a(s, "../dist/index.html")), c.webContents.openDevTools());
}
t.whenReady().then(() => {
